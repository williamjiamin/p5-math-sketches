...
var CAM_LERP_SPEED = 0.055; // smooth interpolation speed
...
function updateCamera() {
  camAz    += (camAzTarget    - camAz)    * CAM_LERP_SPEED;
  camEl    += (camElTarget    - camEl)    * CAM_LERP_SPEED;
...
function drawInteractive3D() {
  ...
  var drawEonFirst = eonP.depth > ripP.depth; // larger depth = further from camera = draw first
  if (drawEonFirst) {
